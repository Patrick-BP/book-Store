  ...
  return (
    ...
    <div className="container max-w-screen-lg mx-auto">
        <div>
            ...
            <p className="text-gray-500 mb-2">Total Price: <span className='font-semibold'>${totalPrice}</span></p>
            <p className="text-gray-500 mb-6">Items: <span className='font-semibold'> {cartItems.length}</span></p>
            </div>
                            ...
                            <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                ...
                                <div className="md:col-span-3">
                                    ...
                                    <input
                                        ...
                                        type="text" name="stress" id="address" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="" />
                                </div>
